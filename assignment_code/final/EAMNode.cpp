...
namespace GLOO {
  EAMNode::EAMNode(ParticleState initial_state, const std::vector<float>& masses, const std::vector<glm::vec3>& colors, IntegratorType type, float step_size)
 : SceneNode() {
...
void EAMNode::Update(double delta_time) {
